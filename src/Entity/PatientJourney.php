...
class PatientJourney extends AbstractContent
{
    ...
    public function setTargetAudience(?string $v):self{$this->targetAudience=$v;return $this;} /** @return Collection<int,JourneyStep> */ public function getSteps():Collection{return $this->steps;}
