...
class Floor extends AbstractTenantEntity
{
    ...
    public function getBuilding():Building{return $this->building;} public function getName():string{return $this->name;} public function setName(string $v):self{$this->name=$v;return $this;}
