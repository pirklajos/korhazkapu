...
class Building extends AbstractTenantEntity
{
    ...
    public function getSite(): Site{return $this->site;} public function getName():string{return $this->name;} public function setName(string $v):self{$this->name=$v;return $this;}
