...
class Room extends AbstractTenantEntity
{
    ...
    public function getFloor():Floor{return $this->floor;} public function setFloor(Floor $v):self{$this->assertSameTenant($v);$this->floor=$v;return $this;} public function getName():string{return $this->name;} public function setName(string $v):self{$this->name=$v;return $this;}
